            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ route('silo-adjustment.update', $silo_setting->id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('storage') ? ' is-invalid' : '' }}" type="text"
                                    name="storage" placeholder="input storage code" value="{{$silo_setting->storage}}">
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('value') ? ' is-invalid' : '' }}" type="number" step="0.1"
                                    name="value" placeholder="input value" value="{{$silo_setting->value}}">
                                @if ($errors->has('value'))
