            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ route('silo-actual.update', $silo_actual->id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <button class="btn   btn-success" type="submit"><i class="far fa-save"></i>
                                    Save</button>
                                <a href="{{ url('setting/silo-actual') }}"><button class="btn   btn-danger" type="button"><i
