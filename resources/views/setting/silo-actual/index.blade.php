            ...
            <div class="col-lg-12 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        {{-- <a href="{{url('setting/silo-actual/create') }}">
                    ...
                    <div class="table-wrapper ">
                        ...
                        <table class="table display responsive nowrap" id="tableSiloActual">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Jurnal</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $silo_actual->silo }}</td>
                                    <td>{{ $silo_actual->date }}</td>
                                    <td>{{ number_format($silo_actual->quantity, 0, '', '.') }} Kg</td>
                                    {{-- <td>{{ $silo_actual->created_at }}</td> --}}
                                    <td>
                                        {{-- <a href="{{url('setting/silo-actual/'.$silo_actual->id.'/edit/') }}">
                                         ...
                                         @if (Auth::user()->departement->name == 'ROOT')
                                            <button class="btn btn-danger btn-sm text-white"
                                                onclick="deleteData('{{$silo_actual->jurnal}}')">
...
@push('js')
    ...
    var table = $('#tableSiloActual').DataTable();
    var buttons = new $.fn.dataTable.Buttons(table, {
        buttons: [{
            extend: 'pdfHtml5',
            title: 'Silo Actual On Hand',
            orientation: 'potrait',
            pageSize: 'A4',
