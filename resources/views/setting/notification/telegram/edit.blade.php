                    ...
                    <div class="row row-sm">
                        <div class="col-lg-12">
                            <div class="card rounded-20">
                                <div class="card-body">
                                <form action="{{route('update_telegram', $telegram->id)}}" method="post">
                                    @csrf
                                    @method('put')
                                        <div class="form-group">
                                            <label for="">BOT TOKEN :</label>
                                             <input type="text" placeholder="" value="{{old('bot_token') ?? $telegram->bot_token}}" name="bot_token" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="">CHANNEL ID :</label>
                                             <input type="text" placeholder="" value="{{ old('channel_id') ?? $telegram->channel_id }}" name="channel_id" class="form-control">
