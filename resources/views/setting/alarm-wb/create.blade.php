            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ url('setting/wb-alarm') }}" enctype="multipart/form-data">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="form-group ">
                                <label for="">Duration (minute)</label>
                                <div class="input-group">
                                    <input class="form-control{{ $errors->has('duration') ? ' is-invalid' : '' }}" type="number"
                                    name="duration" placeholder="input duration" value="{{old('duration')}}">
                                </div>
