            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ url('setting/device/store') }}">
                            @csrf
                            @if ($errors->any())
                            ...
                            placeholder="input device name" value="{{old('name')}}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('device_id') ? ' is-invalid' : '' }}" type="text" name="device_id"
                            placeholder="input device device id" value="{{old('device_id')}}">
