            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ url('setting/voltage-alarm') }}" enctype="multipart/form-data">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    name="normal" placeholder="input value" value="{{old('normal')}}">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    name="range" placeholder="input value" value="{{old('range')}}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">Voltage</span>
                                    </div>
                                </div>
