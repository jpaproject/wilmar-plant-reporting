            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ route('mixer-alarm.update', $mixer_alarm->id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select readonly name="material" id="material" class="form-control mg-r-10">
                                    <option value="{{$mixer_alarm->material}}">{{ucfirst($mixer_alarm->material)}}</option>
                                </select>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    name="sp" placeholder="input value" value="{{$mixer_alarm->sp}}">
                                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <textarea name="text" class="form-control {{ $errors->has('text)') ? ' is-invalid' : '' }}" id="" cols="30" rows="3">{{$mixer_alarm->text}}</textarea>
                                @if ($errors->has('text'))
