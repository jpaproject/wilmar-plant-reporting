            ...
            <div class="col-lg-12 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <a href="{{url('setting/silo-setting/create') }}">
                    ...
                    <div class="table-wrapper ">
                        ...
                        <table class="table display responsive nowrap" id="tableSiloSetting">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Date</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $silo_setting->tstamp }}</td>
                                    <td>{{ $silo_setting->storage }}</td>
                                    <td>{{ $silo_setting->name }}</td>
                                    <td>
                                      <a href="{{url('setting/silo-setting/'.$silo_setting->id.'/edit/') }}">
                                            <button class="btn btn-warning btn-sm text-white">
                                                <i class="icon icon ion ion-edit"></i> Edit
                                            </button>
                                        </a>
                                        <button class="btn btn-danger btn-sm text-white"
                                            onclick="deleteData({{$silo_setting->id}})">
...
@push('js')
    ...
    var table = $('#tableSiloSetting').DataTable();
