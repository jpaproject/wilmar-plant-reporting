            ...
            <div class="col-lg-12 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <a href="{{url('setting/dashboard-alarm/create') }}">
                    ...
                    <div class="table-wrapper ">
                        ...
                        <table class="table display responsive nowrap" id="tableAlarmDashboard">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Material</th>
                            ...
                            <tbody>
                                ...
                                $no=1;
                                @endphp
                                @foreach ($dashboard_alarms as $dashboard_alarm)
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ ucfirst($dashboard_alarm->material) }}</td>
                                    <td>{{ $dashboard_alarm->set_point}}</td>
                                    <td>
                                        <a href="{{url('setting/dashboard-alarm/'.$dashboard_alarm->id.'/edit/') }}">
                                            <button class="btn btn-warning btn-sm text-white">
                                                <i class="icon icon ion ion-edit"></i> Edit
                                            </button>
                                        </a>
                                            <button class="btn btn-danger btn-sm text-white"
                                                onclick="deleteData({{$dashboard_alarm->id}})">
...
@push('js')
    ...
    var table = $('#tableAlarmDashboard').DataTable();
