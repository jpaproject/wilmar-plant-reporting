            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ url('setting/dashboard-alarm') }}"" enctype="multipart/form-data">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <select readonly name="material" id="material" class="form-control mg-r-10">
                                    <option value="{{$dashboard_alarm->material}}">{{ucfirst($dashboard_alarm->material)}}</option>
                                </select>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    name="set_point" placeholder="input value" value="{{$dashboard_alarm->set_point}}">
                                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <textarea name="text" class="form-control {{ $errors->has('text)') ? ' is-invalid' : '' }}" id="" cols="30" rows="3">{{$dashboard_alarm->text}}</textarea>
                                @if ($errors->has('text'))
                            ...
                            <div class="form-group">
                                <button class="btn   btn-success" type="submit"><i class="far fa-save"></i>
                                    Save</button>
                                <a href="{{ url('setting/dashboard-alarm') }}"><button class="btn   btn-danger" type="button"><i
