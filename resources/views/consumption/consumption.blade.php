    ...
    <div class="row row-sm mg-t-20">
        ...
        <div class="col-md-12 mg-t-20">
            <div class="card bd-0 shadow-base  rounded-20">
                <div class="card-header tx-medium bd-0 tx-white bg-mantle d-flex justify-content-between align-items-center"
                    style="border-radius: 122px;border-bottom-left-radius: 0px;">
                    <h6 class="card-title tx-uppercase text-white tx-12 mg-b-0">DATA EXIST : {{$deviceActive->name}}
                    </h6>
                ...
                <div class="card-body pd-t-40 pd-b-20  justify-content-between align-items-center">
                    <div class="wd-100p ht-400" id="data-exist" width=""></div>
                    <div class="">
                        <div id="buttons" style="padding: 10px; margin-bottom: 10px;width: 25%;">
                            <p>Download :</p>
                        </div>

                        <table id="table-existing" class="table table-bordered table-hover">
                            <thead>
                                <th width="1%">No</th>
                                <th width="15%">Date</th>
                                <th>KWH Exist</th>
        ...
        <div class="col-md-12 mg-t-20">
            <div class="card bd-0 shadow-base  rounded-20">
                <div class="card-header tx-medium bd-0 tx-white bg-mantle d-flex justify-content-between align-items-center"
                    style="border-radius: 122px;border-bottom-left-radius: 0px;">
                    <h6 class="card-title tx-uppercase text-white tx-12 mg-b-0">DATA TOTAL : {{$deviceActive->name}}
                    </h6>
                    <span class="tx-12 tx-uppercase" id="dateTag1"></span>
                </div><!-- card-header -->
                <div class="card-body pd-t-40 pd-b-20  justify-content-between align-items-center">
...
<script>
    ...
    var buttons = new $.fn.dataTable.Buttons(table, {
        buttons: [{
            extend: 'pdfHtml5',
            title: 'Power Consumption (Data Existing)',
            orientation: 'potrait',
            pageSize: 'A4',
