            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ route('alarm-setting.store') }}">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="form-group {{ $errors->has('tag_name') ? ' has-danger' : '' }}">
                                ...
                                <select class="form-control select2 " name="tag_name">
                                    <option value="tonnage_hm1">Tonnage Hammer Mill 1</option>
                                    <option value="kwh_ton_hm1">kWh/Ton Hammer Mill 1</option>
                                </select>
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('sp') ? ' is-invalid' : '' }}" type="number" step="0.01" min="0" lang="en" value="0"
                                    name="sp" placeholder="input sp" value="{{old('sp')}}">
                                @if ($errors->has('sp'))
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('text') ? ' is-invalid' : '' }}" type="text"
                                    name="text" placeholder="input text" value="{{old('text')}}">
                                @if ($errors->has('text'))
