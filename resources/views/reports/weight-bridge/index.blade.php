...
<div class="br-pagebody">
    ...
    <div class="bg-dance text-white rounded-20 pd-20 mg-t-40">
        <!-- <div class="text-center d-flex  bg-royal rounded-20 pd-10 text-white"
            ...
            <img src="{{asset('backend/images/icon/wb-white.png')}}" class="ht-50 rounded-circle" alt="">
        ...
        <p class="text-right text-black hidden-sm-down" style="margin-top: -40px;color:black">{{Request::input('date') == '' ? date('Y-m-d') : Request::input('date') }}</p>
        <div class="row ">
                        ...
                        <div class="wd-100p table-responsive ">
                            ...
                            <table class="table" id="table1">
                                <thead>
                                    ...
                                    <th class=" ">Item No</th>
                                    <th class=" ">Date In</th>
                                    <th class=" ">Date Out</th>
                                    <th class=" ">Time In</th>
                                    <th class=" ">Time Out</th>
                                    {{-- <th class=" ">Location</th> --}}
                                    {{-- <th class=" ">Jumlah Bag</th> --}}
                                    <th class=" ">Nett</th>
                                    {{-- <th class=" ">Nett-potong</th> --}}
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$wbfile->itemno ?: '-'}}</td>
                                        <td>{{$wbfile->datein }}</td>
                                        <td>{{$wbfile->dateout }}</td>
                                        <td>{{$wbfile->timein }}</td>
                                        <td>{{$wbfile->timeout }}</td>
                                        {{-- <td>{{$wbfile->site }}</td> --}}
                                        {{-- <td>{{$wbfile->jumlah_bag }}</td> --}}
                                        <td>{{$wbfile->nett }}</td>
                                        {{-- <td>{{$wbfile->nett_potong }}</td> --}}
