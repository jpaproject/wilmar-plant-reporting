...
function tonnage() {
    ...
    option1 = {
        legend: {
            data: ['Pellet Mill 1', 'Pellet Mill 2', 'Pellet Mill 3', 'Pellet Mill 4'],
            textStyle: {
                color: "#ffffff"
            }
        },
        ...
        series: [{
            ...
            },
            {
                ...
                color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                    offset: 0,
                    color: '#8080C0' // color at 0% position
                }, {
                    offset: 1,
                    color: '#fba60c' // color at 100% position
                }], false)
...
$(function () {
    ...
    var current = echarts.init(document.getElementById('current-motor'));
    var current_motor = echarts.init(document.getElementById('current'));
